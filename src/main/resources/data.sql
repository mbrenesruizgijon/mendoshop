...
INSERT INTO `usuarios` (`id`, `ciudad`, `codigo_postal`, `contrasena`, `direccion`, `email`, `nombre`, `telefono`, `activo`) VALUES
...
INSERT INTO `productos` (`id`, `precio`, `nombre`, `categoria`, `descripcion`, `url_imagen`, `stock`, `peso`, `descuento`) VALUES
...
INSERT INTO `carnes` (`id`, `tipo_animal`, `origen`) VALUES
(1, 'Vacuno', 'Argentina'),
(2, 'Pollo', 'España'),
(3, 'Cerdo', 'Alemania'),
(4, 'Cordero', 'Francia'),
...
INSERT INTO `verduras` (`id`, `tipo_verdura`, `es_temporada`) VALUES
(6, 'Hoja', 1),
(7, 'Fruto', 1),
(8, 'Raiz', 0),
(9, 'Hoja', 1),
...
INSERT INTO `pedidos` (`id`, `direccion_envio`, `fecha_entrega_estimada`, `fecha_pedido`, `total`, `usuario_id`, `estado`) VALUES
...
INSERT INTO `pedido_productos` (`pedido_id`, `cantidad`, `producto_id`) VALUES
(1, 1, 5),
(1, 1, 10);